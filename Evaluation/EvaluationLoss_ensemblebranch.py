...
file = open('accuracy_ensemble_branch_fusion.txt', 'a')
for i in range(0, 6):
	loss_count = 0;
	...
	for loss in loss_list:
		...
		id = ['4a', '4', '5a', '5', '6a', '6']
		for n in range(0, N):
			dir_name = '/home/zhangyuan/caojiajiong/attribute_learning/features_all/branch_conv' + id[n] + '_fusion_' + str(i*10000+60000) + '/'
