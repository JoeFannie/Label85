...
file = open('accuracy_dropout_inception_conv23attr_111_decay7.txt', 'a')
for i in range(0, 6):
	print i
	loss_count = 0;
	...
	for loss in loss_list:
		dir_name = '/home/zhangyuan/caojiajiong/attribute_learning/features_all/dropout_inception_conv23attr_111_decay7_' + str(i*10000+50000) + '/'
