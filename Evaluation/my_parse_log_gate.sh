...
grep 'Test net output #2: ' $1 | awk '{print $11}' > aux5.txt
grep 'Test net output #3: ' $1 | awk '{print $11}' > aux6.txt
grep 'Test net output #4: ' $1 | awk '{print $11}' > aux7.txt
grep 'Test net output #5: ' $1 | awk '{print $11}' > aux8.txt
grep 'Test net output #6: ' $1 | awk '{print $11}' > aux9.txt
grep 'Test net output #7: ' $1 | awk '{print $11}' > aux10.txt
grep 'Test net output #8: ' $1 | awk '{print $11}' > aux11.txt
