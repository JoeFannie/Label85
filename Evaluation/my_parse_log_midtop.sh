...
grep 'Test net output #2: loss_5_o_Clock_Shadow = ' $1 | awk '{print $11}' > aux5.txt
grep 'Test net output #3: loss_Arched_Eyebrows = ' $1 | awk '{print $11}' > aux6.txt
grep 'Test net output #4: loss_Attractive = ' $1 | awk '{print $11}' > aux7.txt
grep 'Test net output #5: loss_Bags_Under_Eyes = ' $1 | awk '{print $11}' > aux8.txt
grep 'Test net output #6: loss_Bald = ' $1 | awk '{print $11}' > aux9.txt
grep 'Test net output #7: loss_Bangs = ' $1 | awk '{print $11}' > aux10.txt
grep 'Test net output #8: loss_Big_Lips = ' $1 | awk '{print $11}' > aux11.txt
grep 'Test net output #9: loss_Big_Nose = ' $1 | awk '{print $11}' > aux12.txt
grep 'Test net output #10: loss_Black_Hair = ' $1 | awk '{print $11}' > aux13.txt
grep 'Test net output #11: loss_Blond_Hair = ' $1 | awk '{print $11}' > aux14.txt
grep 'Test net output #12: loss_Blurry = ' $1 | awk '{print $11}' > aux15.txt
grep 'Test net output #13: loss_Brown_Hair = ' $1 | awk '{print $11}' > aux16.txt
grep 'Test net output #14: loss_Bushy_Eyebrows = ' $1 | awk '{print $11}' > aux17.txt
grep 'Test net output #15: loss_Chubby = ' $1 | awk '{print $11}' > aux18.txt
grep 'Test net output #16: loss_Double_Chin = ' $1 | awk '{print $11}' > aux19.txt
grep 'Test net output #17: loss_Eyeglasses = ' $1 | awk '{print $11}' > aux20.txt
grep 'Test net output #18: loss_Goatee = ' $1 | awk '{print $11}' > aux21.txt
grep 'Test net output #19: loss_Gray_Hair = ' $1 | awk '{print $11}' > aux22.txt
grep 'Test net output #20: loss_Heavy_Makeup = ' $1 | awk '{print $11}' > aux23.txt
grep 'Test net output #21: loss_High_Cheekbones = ' $1 | awk '{print $11}' > aux24.txt
grep 'Test net output #22: loss_Male = ' $1 | awk '{print $11}' > aux25.txt
grep 'Test net output #23: loss_Mouth_Slightly_Open = ' $1 | awk '{print $11}' > aux26.txt
grep 'Test net output #24: loss_Mustache = ' $1 | awk '{print $11}' > aux27.txt
grep 'Test net output #25: loss_Narrow_Eyes = ' $1 | awk '{print $11}' > aux28.txt
grep 'Test net output #26: loss_No_Beard = ' $1 | awk '{print $11}' > aux29.txt
grep 'Test net output #27: loss_Oval_Face = ' $1 | awk '{print $11}' > aux30.txt
grep 'Test net output #28: loss_Pale_Skin = ' $1 | awk '{print $11}' > aux31.txt
grep 'Test net output #29: loss_Pointy_Nose = ' $1 | awk '{print $11}' > aux32.txt
grep 'Test net output #30: loss_Receding_Hairline = ' $1 | awk '{print $11}' > aux33.txt
grep 'Test net output #31: loss_Rosy_Cheeks = ' $1 | awk '{print $11}' > aux34.txt
grep 'Test net output #32: loss_Sideburns = ' $1 | awk '{print $11}' > aux35.txt
grep 'Test net output #33: loss_Smiling = ' $1 | awk '{print $11}' > aux36.txt
grep 'Test net output #34: loss_Straight_Hair = ' $1 | awk '{print $11}' > aux37.txt
grep 'Test net output #35: loss_Wavy_Hair = ' $1 | awk '{print $11}' > aux38.txt
grep 'Test net output #36: loss_Wearing_Earrings = ' $1 | awk '{print $11}' > aux39.txt
grep 'Test net output #37: loss_Wearing_Hat = ' $1 | awk '{print $11}' > aux40.txt
grep 'Test net output #38: loss_Wearing_Lipstick = ' $1 | awk '{print $11}' > aux41.txt
